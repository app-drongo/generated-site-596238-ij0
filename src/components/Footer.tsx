...
// Generated: 2025-08-20T03:29:38.730Z
// Section: footer
// Category: footer
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              ...
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                Streamlining your SAP integration and business processes for optimal efficiency and performance.
                Trust our expert team to transform your digital landscape.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-muted-foreground">
                Get the latest updates and insights on SAP integration and business transformation.
              </p>
            </div>
          </div>
