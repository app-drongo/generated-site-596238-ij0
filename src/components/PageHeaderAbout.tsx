...
// Generated: 2025-08-20T03:29:39.262Z
// Section: page-header
// Category: page-header
// Template ID: page-header-c001-about
// Page: About
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative py-16 sm:py-20 lg:py-24 max-w-4xl">
          ...
          <Badge variant="outline" className="mb-4 px-4 py-2">
            About SAP Integration Consulting
          </Badge>
          ...
          <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed max-w-3xl">
            Discover how our team of SAP integration experts can help your business unlock the full potential 
            of your SAP systems, streamline operations, and drive sustainable growth.
          </p>
        </div>
      </div>
    </section>
